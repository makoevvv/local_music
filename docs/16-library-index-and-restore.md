...
> **Этап 4 (search/download):** индекс **ещё не ведётся**. Источник сохраняется в `tracks.source_*`. Запись в `track_sources` и CLI `index export/import` — **этап 4.2** ([`12-roadmap.md`](12-roadmap.md:95)).
